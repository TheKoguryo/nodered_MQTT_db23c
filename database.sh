...
sudo wget https://download.oracle.com/otn-pub/otn_software/db-free/oracle-database-free-23ai-1.0-1.el8.x86_64.rpm



echo "***Installing DB 23ai free***" 
sudo dnf -y install oracle-database-free-23ai-1.0-1.el8.x86_64.rpm


#Configure the Database
echo "***Configuring DB***" 
export DB_PASSWORD=Tiger$tr0ng2023
(echo "${DB_PASSWORD}"; echo "${DB_PASSWORD}";) | sudo /etc/init.d/oracle-free-23ai configure
...
echo ". /opt/oracle/product/23ai/dbhomeFree/bin/oraenv" >> /home/opc/.bashrc
